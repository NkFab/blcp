...
"[project]/Projects/tests/blcp/blcp-frontend/app/api/applications/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (user.role === 'applicant') {
            applications = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getApplicationsByApplicant(user.id);
        } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])(user.role, 'canViewAllApplications')) {
            applications = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getAllApplications();
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_react$2d$dom$40$19$2e$2$2e$6_react$40$19$2e$2$2e$6_$5f$react$40$19$2e$2$2e$6$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Forbidden'
        ...
        const enrichedApplications = applications.map((app)=>{
            const applicant = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getUserById(app.applicantId);
            const reviewer = app.reviewerId ? __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getUserById(app.reviewerId) : null;
            const approver = app.approverId ? __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getUserById(app.approverId) : null;
            return {
                ...app,
...
async function POST(request) {
    try {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])(user.role, 'canCreateApplication')) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_react$2d$dom$40$19$2e$2$2e$6_react$40$19$2e$2$2e$6_$5f$react$40$19$2e$2$2e$6$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        const { bankName, bankType, businessAddress, contactEmail, contactPhone, proposedCapital, businessPlan, submit } = body;
        // Validate required fields
        if (!bankName || !bankType || !businessAddress || !contactEmail || !contactPhone || !proposedCapital || !businessPlan) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_react$2d$dom$40$19$2e$2$2e$6_react$40$19$2e$2$2e$6_$5f$react$40$19$2e$2$2e$6$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        if (!validBankTypes.includes(bankType)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_react$2d$dom$40$19$2e$2$2e$6_react$40$19$2e$2$2e$6_$5f$react$40$19$2e$2$2e$6$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        const application = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].createApplication({
            applicantId: user.id,
            bankName,
            bankType,
            businessAddress,
            contactEmail,
            contactPhone,
            proposedCapital: Number(proposedCapital),
            businessPlan,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].appendAuditLog({
            ...
            userName: user.name,
            userRole: user.role,
            action: submit ? 'application_submitted' : 'application_created',
            entityType: 'application',
            entityId: application.id,
            stateBefore: null,
            stateAfter: JSON.stringify(application),
            metadata: JSON.stringify({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b2bd4710._.js.map