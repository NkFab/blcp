...
"[project]/Projects/tests/blcp/blcp-frontend/app/api/applications/[id]/documents/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const documents = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getDocumentsByApplication(id, includeAllVersions);
        return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_react$2d$dom$40$19$2e$2$2e$6_react$40$19$2e$2$2e$6_$5f$react$40$19$2e$2$2e$6$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            documents
        });
...
async function POST(request, { params }) {
    try {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasPermission"])(user.role, 'canUploadDocuments')) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_react$2d$dom$40$19$2e$2$2e$6_react$40$19$2e$2$2e$6_$5f$react$40$19$2e$2$2e$6$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        // Only the applicant can upload documents to their own application
        ...
        // Can only upload to draft, submitted, or additional_info_required applications
        ...
        if (!allowedStatuses.includes(application.status)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_react$2d$dom$40$19$2e$2$2e$6_react$40$19$2e$2$2e$6_$5f$react$40$19$2e$2$2e$6$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Cannot upload documents to applications in this status'
            }, {
                status: 400
            });
        }
        const body = await request.json();
        const { name, type, size, previousVersionId } = body;
        // Validate file size
        ...
        if (previousVersionId) {
            const previousDoc = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].getDocumentById(previousVersionId);
            if (previousDoc && previousDoc.applicationId === id) {
                version = previousDoc.version + 1;
            }
        }
        // Create document metadata (simulating file storage)
        const document = __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].createDocument({
            applicationId: id,
            name,
            type,
            size,
            ...
            isLatest: true,
            storagePath: `/documents/${id}/${name.replace(/\s+/g, '_')}_v${version}`
        });
        // Log the action
        __TURBOPACK__imported__module__$5b$project$5d2f$Projects$2f$tests$2f$blcp$2f$blcp$2d$frontend$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].appendAuditLog({
            userId: user.id,
            ...
            userName: user.name,
            userRole: user.role,
            action: previousVersionId ? 'document_version_added' : 'document_uploaded',
            entityType: 'document',
            entityId: document.id,
            stateBefore: null,
            stateAfter: JSON.stringify(document),
            metadata: JSON.stringify({
                applicationId: id,
                fileName: name,
                version
...
//# sourceMappingURL=%5Broot-of-the-server%5D__300a581e._.js.map